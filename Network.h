...
public:
    ...
    vector<ApplicationLayerPacket> ApplicationLayer ;
    vector<TransportLayerPacket> TransportLayer;
    vector<NetworkLayerPacket> NetworkLayer ;
    vector<PhysicalLayerPacket> PhysicalLayer;
